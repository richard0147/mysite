...
def getDnslaCurrentData(request):
    global mrtg_image_dic
    return  HttpResponse(json.dumps(dnsla_image_dic)) 
...
def get_dnsla_image():
    ...
    for i in xrange(0,32):
        ...
        #x_list,y_list=dnsla_get_json_data(url=dnsla_dname_url,nodeid=i,topn=10,data_type='addr')
