...
mrtgChoices=(('1','CNNIC'),('2','瑞典'),('4','成都电信'),('5','广州移动'),('6','韩国'),('7','德国'),('8','Neustar'),('9','香港'),('10','美国ISC'),('11','广州电信'),)
class ReportForm(forms.Form):
    ...
    domain=ProcessMultiField(label='攻击域名')
    ...
    process=ProcessMultiField(required=False,label='处理过程',widget=processWidget(attrs={'class': 'form-control'}))
